...
//! Traits and Structs for vhost backend drivers.

use std::os::unix::io::RawFd;
use vmm_sys_util::EventFd;

/// Error codes associated with handling vHost commands.
#[derive(Debug)]
pub enum Error {
    /// Invalid operations.
    InvalidOperation,
...
/// Configuration data for a vring
...
pub struct VhostUserMemoryRegionInfo {
    ...
    pub memory_size: u64,
    /// Optional virtual address in the current process.
